...
function Index() {
  ...
  var handleMouseMove = function handleMouseMove(ev) {
    ...
    console.log(Object(_libs_transform__WEBPACK_IMPORTED_MODULE_8__["default"])(clientY, [clientY - top, clientY - top + height], [-30, 30]));
    setSpring({
      rotateX: Object(_libs_transform__WEBPACK_IMPORTED_MODULE_8__["default"])(clientY, [clientY - top, clientY - top + height], [-30, 30]),
      rotateY: Object(_libs_transform__WEBPACK_IMPORTED_MODULE_8__["default"])(clientX, [clientX - left, clientX - left + width], [-30, 30]),
      scale: 1.2
    });
  };
...
//# sourceMappingURL=index.js.7ad345b218e5eb80f516.hot-update.js.map